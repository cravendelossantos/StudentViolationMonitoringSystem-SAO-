...
@section('title', 'SAO | Checklist Requirements')
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="input-group ">
							<input type="text" placeholder="Name of Organization" id="organizationName" name="organizationName" value="asdf" class="form-control" autofocus="" aria-required="true">
...
var requirements_renewal_table = $('.requirements-DT').DataTable({
    ...
    "ajax": {
    	...
    	url : "/organizationsRenewal/requirements/all",
		type: "POST",
			},
	"bSort" : true,
	"bFilter" : true,
	...
	"columns" : [
		...
		"render":function(data,type,full,meta){
			...
			if(data == 0){
				return '<center><input type="checkbox" class="i-checks" name="requirement1"></center>';
			} else{
				return '<center><input type="checkbox" class="i-checks" name="requirement1" checked=""></center>';
			}
		}
}],

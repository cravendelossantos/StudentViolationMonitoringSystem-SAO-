					...
					<div class="panel-heading">
						...
						<div class="panel-options">
							...
							<ul class="nav nav-tabs">
								<li class="active"><a data-toggle="tab" href="#tab-1">Manage Sanctions</a></li>
								<li class=""><a data-toggle="tab" href="#tab-2">Community Service</a></li>
								<li class=""><a data-toggle="tab" href="#tab-3">Suspensions / Exclusions</a></li>
							</ul>
						</div>
					</div>
					...
					<div class="panel-body">
						...
						<div class="tab-content">
									...
									<form id="sanctions_form">
										...
										<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
											...
											<table class="table table-striped table-bordered table-hover sanctions-DT dataTable" id="sanctions-DT" aria-describedby="DataTables_Table_0_info" role="grid">
												<thead>
													<tr><th colspan="10"><center>Click the row to update its sanction</center></th></tr>
													<tr>
							...
							<div class="panel panel-primary">
								<div class="panel-heading"><h4>Time Log</h4></div>
								<div class="panel-body">
									<form id="time_log">
									...
									<div class="panel-footer">
										<button class="btn btn-primary " name="time_log_btn" id="time_log_btn" type="button"><i class="fa fa-check"></i>&nbsp;Submit</button>
									</div>
						...
						<div id="tab-3" class="tab-pane">
							...
							<div class="input-group">
								...
								<input type="text" name="suspensions_student_no" class="form-control"> <span class="input-group-btn"> <button type="button" id="suspensions_student_find" class="btn btn-primary">Find
							</button> </span>
						</div>
						...
						<div class="table-responsive">
							<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
								...
								<table class="table table-striped table-bordered table-hover suspensions-DT dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
									<thead>
										<tr><th colspan="4"><center>List of Suspended Students</center></th></tr>
										<tr>
											<th>Student No.</th>
											<th>First Name</th>
											<th>Last Name</th>
							...
							<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
								...
								<table class="table table-striped table-bordered table-hover exclusion-DT dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
									<thead>
										...
										<tr><th colspan="4"><center>List of Excluded Students</center></th></tr>
										<tr>
											<th>Student No.</th>
											<th>First Name</th>
											<th>Last Name</th>
		...
		<div class="modal-content">
			...
			<div class="ibox-content">
				<form class="form-horizontal suggestTopic" id="add_suspension">
					...
					<div class="form-group">
						<div class="col-md-10 col-md-offset-1">
							<input type="radio"  name="suspension_exclusion" value="Suspend"> Suspend<br>
							<br>
							<input type="number" placeholder="No. of days" class="form-control" id="suspension_days" name="suspension_days">
							<br>
							<input type="radio" 	name="suspension_exclusion" value="Exclude"> Exclude<br>
						</div>			
					</div>
			...
			if (data.success == false) {
				...
				if (data.response == null)
				{
					...
					if (data.response['current_status'] == "Excluded")
					{
						...
						var suspended_student_no = data.response.student_id;
						var suspension_id = data.response.id;

						$('#suspended_student_no').val(suspended_student_no);
						$('#suspension_id').val(suspension_id);
